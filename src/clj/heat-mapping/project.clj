(defproject heat-mapping "0.1.0"
  :description "The heat mapping business component"
  ...
  :dependencies [[amalloy/ring-gzip-middleware "0.1.2" :exclusions [org.clojure/clojure]]
                 ...
                 [log4j/log4j "1.2.16" :exclusions [javax.mail/mail javax.jms/jms com.sun.jdmk/jmxtools com.sun.jmx/jmxri]]                                    [lib-noir "0.4.7" :exclusions [[org.clojure/clojure] [compojure] [hiccup] [ring]]]
                 [ring "1.2.0"]                 
                 ...
                 [shoreleave "0.3.0"]]
  :ring {:handler heat-mapping.handler/war-handler
         :init heat-mapping.handler/init
         :destroy heat-mapping.handler/destroy}
  :main heat-mapping.server
