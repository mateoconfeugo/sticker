(defproject lead-generation "0.1.0"
  :description "Lead Generation business component"
  ...
  :dependencies [[org.clojure/clojure "1.5.1"]
                 ...
                 [shoreleave "0.3.0"]]
  :ring {:handler lead-generation.handler/war-handler
         :init lead-generation.handler/init
         :destroy lead-generation.handler/destroy}
  :main lead-generation.server
