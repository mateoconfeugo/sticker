...
output += '</li>\n  <li><a href="#new">What We Do &nbsp;<i class="icon-bell icon-large"></i></a></li>\n  <li><a href="#new">Take a Test Drive &nbsp;<i class="icon-bell icon-large"></i></a></li>\n  <li><a href="#warnings">Contact Us &nbsp;<i class="icon-warning-sign icon-large"></i></a></li>\n  <li><a href="#warnings">Sign Up Now! &nbsp;<i class="icon-warning-sign icon-large"></i></a></li>\n  <li><a href="#warnings">Login &nbsp;<i class="icon-warning-sign icon-large"></i></a></li>\n</ul>\n</div><!--/.nav-collapse -->\n\n';
...
Jemplate.templateMap['tool_menu_item'] = function(context) {
    ...
    try {
output += '	      \n<a href="#new" class="dropdown-toggle" role="button" data-toggle="dropdown" href="#">Products and Services &nbsp; <i class="icon-plus icon-large"></i></a>\n<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">\n  <li><a tabindex="-1" href="#">Landing Site Builder</a></li>\n  <li><a tabindex="-1" href="#">Marketing Vector Manager</a></li>\n  <li><a tabindex="-1" href="#">Vertical Site Builder</a></li>\n  <li><a tabindex="-1" href="#">Campaign Manager</a></li>\n  <li><a tabindex="-1" href="#">Keyword Manager</a></li>\n  <li><a tabindex="-1" href="#">Training</a></li>\n  <li><a tabindex="-1" href="#">Distributor Builder Program</a></li>\n</ul>\n';
    }
    catch(e) {
        var error = context.set_error(e, output);
        throw(error);
