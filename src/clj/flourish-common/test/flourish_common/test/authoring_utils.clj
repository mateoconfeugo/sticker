...
(def tmpl-path  (str (System/getProperty "user.dir") "/test/flourish_common/test/" test-uuid ".html"))
(def resource-tmpl-path  "templates/1.html")
;;(def resource-tmpl-path  "./1.html")
...
(def result (clutch/update-document db doc {:html test-html}))
...
(load-file (str (System/getProperty "user.dir")"/test/generated_enlive_template.clj"))
