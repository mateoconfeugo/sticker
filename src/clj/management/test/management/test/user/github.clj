(ns management.test.user.github
...
(read-json (slurp "https://graph.facebook.com/btaylor"))
{:id "220439",
 :name "Bret Taylor",
 :first_name "Bret",
 :last_name "Taylor",
...
(add-webhook test-webhooksettings)
...
(read-json (slurp "https://api.heroku.com/apps"))
{:api-key heroku-api-token
 :name "marketingwithgusto.com-1-test-1"
 :git_url "https://github.com/mateoconfeugo/marketingwithgusto.com-1-test-1"
}
