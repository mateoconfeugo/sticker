package CMS::Action::CreateCategories::Test;
use strict;
use warnings;
...
use CMS::Action::CreateCategories;
...
test plan => 1, test_cms_create_categories_action => sub {
    my ($self) = @_;
...
#		      {
#			  name => 'top level test',
#			  description => 'The root test category',
#			  directory => '/',
#			  uri => '/',
#		      },
		      {
