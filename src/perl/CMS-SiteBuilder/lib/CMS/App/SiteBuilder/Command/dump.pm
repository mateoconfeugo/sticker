package CMS::App::SiteBuilder::Command::dump;
########################################################################
# ABSTRACT:  CMS::App::SiteBuilder::Command::backup
#            Dump the complete contents of a bricolage as a tarball 
#            to, directory or a par
########################################################################
use Moose;
