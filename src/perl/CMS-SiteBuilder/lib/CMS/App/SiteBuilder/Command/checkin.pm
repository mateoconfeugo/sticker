package CMS::App::SiteBuilder::Command::checkin;
########################################################################
# ABSTRACT:  CMS::App::SiteBuilder::Command::source_control
#            move all the artifacts that describe and make up a 
#            bricolage site EXCEPT the actual content.
########################################################################
use Moose;
